...
- `docs/architecture/milestone-12.md` is the latest rollout-planning document and describes remote Pi structured-provider expansion with iPhone parity.
...
- `Modules/Sources/NexusService` — service-owned orchestration, persistence, provider adapters, session runtime logic
