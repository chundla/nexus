    ...
    struct RemoteProtocolSessionCommandBuilder {
        ...
        private func remoteCommand(
            ...
            case .launchNew:
                return [
                    ...
                    bridgeScript(
                        runtimeIdentifier: runtimeIdentifier, inputFIFO: "$input_fifo", outputLog: "$output_log",
        ...
        private func bridgeScript(runtimeIdentifier: String, inputFIFO: String, outputLog: String, bootstrapLog: String)
            -> String
        {
            [
