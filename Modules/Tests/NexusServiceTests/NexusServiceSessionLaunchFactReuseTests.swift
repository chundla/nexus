...
struct NexusServiceSessionLaunchFactReuseTests {
    @Test func freshLocalLaunchReusesRecentProviderHealthSnapshotAcrossBootstrap() async throws {
        ...
        let session = try await secondService.launchOrResumeDefaultSession(workspaceID: workspace.id, providerID: .claude)
    ...
    @Test func remoteRelaunchWithLaunchSnapshotSkipsFreshProviderHealthChecks() async throws {
        ...
        let session = try await firstService.launchOrResumeDefaultSession(workspaceID: workspace.id, providerID: .claude)
    ...
    @Test func remoteRelaunchFallsBackToFreshProviderHealthWhenCachedSnapshotIsStale() async throws {
        ...
        let relaunchedSession = try await secondService.launchOrResumeDefaultSession(workspaceID: workspace.id, providerID: .claude)
