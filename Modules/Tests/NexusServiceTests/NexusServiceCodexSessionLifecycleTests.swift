    ...
    private func makeCodexLifecycleService(rootURL: URL, transportHarness: PersistentCodexTransportHarness) throws
        -> NexusService
    {
    ...
    private struct CodexLifecycleStubCommandRunner: ProviderCommandRunning {
        ...
        func run(executable: String, arguments: [String], currentDirectoryURL: URL?) throws -> ProviderCommandResult {
            guard let result = results[Invocation(executable: executable, arguments: arguments)] else {
                throw NSError(
                    domain: "CodexLifecycleStubCommandRunner", code: 1,
    ...
    private final class PersistentCodexTransportHarness: @unchecked Sendable {
        ...
        func recordLaunch(method: String, requestedThreadID: String?) -> String {
            ...
            recordedLaunches.append(
                Launch(method: method, requestedThreadID: requestedThreadID, resolvedThreadID: resolvedThreadID))
