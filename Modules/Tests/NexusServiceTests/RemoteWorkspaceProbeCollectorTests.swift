                        ...
                        RemoteWorkspaceProbeFacts(
                            ...
                            providerFacts: [
                                .claude: RemoteProviderProbeFacts(
                                    executable: "/opt/tools/claude", version: "1.2.3", resolutionDetail: nil,
                                    probeDetail: nil),
                                .codex: RemoteProviderProbeFacts(
                                    executable: "/opt/tools/codex", version: "0.9.0", resolutionDetail: nil,
                                    probeDetail: nil),
                                .pi: RemoteProviderProbeFacts(
                                    executable: "/opt/tools/pi", version: "3.1.4", resolutionDetail: nil,
                                    probeDetail: nil),
                                .ibmBob: RemoteProviderProbeFacts(
                                    executable: "/opt/tools/bob", version: "2026.05", resolutionDetail: nil,
                                    probeDetail: nil),
                            ]
                        )
                    ))
